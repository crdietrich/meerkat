#!/usr/bin/python
"""i2c bus base class for Atlas Scientific sensors
More info at: http://www.atlas-scientific.com/
Sensor default addresses are:
0x61 : Dissolved Oxygen
0x62 : Oxidation Reduction Potential
0x63 : pH
0x64 : Conductivity
...
2. Default i2c bus is 0 in earlier models, 1 in later.
    Use the following command to find attached devices during hardware setup:
    $ sudo i2cdetect -y 0
    $ sudo i2cdetect -y 1

Atlas Scientific, 2015
Colin Dietrich, 2015
"""
...
def main():
    """Atlas Scientific supplied command line interface"""
